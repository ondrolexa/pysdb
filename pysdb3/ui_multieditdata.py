...
# Form implementation generated from reading ui file 'multieditdata.ui'
#
...
class Ui_DialogMultiEditData(object):
    def setupUi(self, DialogMultiEditData):
        ...
        self.buttonBox.accepted.connect(DialogMultiEditData.accept) # type: ignore
        self.buttonBox.rejected.connect(DialogMultiEditData.reject) # type: ignore
