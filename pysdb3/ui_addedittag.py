...
# Form implementation generated from reading ui file 'addedittag.ui'
#
...
class Ui_DialogAddEditTag(object):
    def setupUi(self, DialogAddEditTag):
        ...
        self.buttonBox.accepted.connect(DialogAddEditTag.accept) # type: ignore
        self.buttonBox.rejected.connect(DialogAddEditTag.reject) # type: ignore
