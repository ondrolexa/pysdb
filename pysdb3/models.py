...
CREATE TABLE IF NOT EXISTS "tagged" ("id" INTEGER, "id_tags" INTEGER NOT NULL, "id_structdata" INTEGER NOT NULL, PRIMARY KEY("id_tags","id_structdata"), FOREIGN KEY("id_tags") REFERENCES "tags"("id"), FOREIGN KEY("id_structdata") REFERENCES "structdata"("id"));
