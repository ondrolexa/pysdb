...
# Form implementation generated from reading ui file 'savediscard.ui'
#
...
class Ui_SaveDiscardDialog(object):
    def setupUi(self, SaveDiscardDialog):
        ...
        self.buttonBox.accepted.connect(SaveDiscardDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(SaveDiscardDialog.reject) # type: ignore
